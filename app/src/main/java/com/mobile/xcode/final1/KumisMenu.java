...
public class KumisMenu extends ListActivity{
	String [] menu = {"Makanan", "Minuman"};
	
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.kumis_menu);
	...
	private void tampilkanpilihan(String pilihan) {
		...
		try
		{
			...
			if(pilihan.equals("Makanan"))
				{
					pindah = new Intent(KumisMenu.this, KumisMakanan.class);
				}
			else if(pilihan.equals("Minuman"))
			{
				pindah = new Intent(this, KumisMinuman.class);
			}
