...
public class BuanaMenu extends ListActivity{
	String [] menu = {"Makanan", "Minuman"};
	
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.buana_menu);
	...
	private void tampilkanpilihan(String pilihan) {
		...
		try
		{
			...
			if(pilihan.equals("Makanan"))
				{
					pindah = new Intent(BuanaMenu.this, BuanaMakanan.class);
				}
			else if(pilihan.equals("Minuman"))
			{
				pindah = new Intent(this, BuanaMinuman.class);
			}
