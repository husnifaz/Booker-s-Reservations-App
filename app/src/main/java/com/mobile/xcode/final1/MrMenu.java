...
public class MrMenu extends ListActivity{
	String [] menu = {"Makanan", "Minuman"};
	
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.mr_menu);
	...
	private void tampilkanpilihan(String pilihan) {
		...
		try
		{
			...
			if(pilihan.equals("Makanan"))
				{
					pindah = new Intent(MrMenu.this, MrMakanan.class);
				}
			else if(pilihan.equals("Minuman"))
			{
				pindah = new Intent(this, MrMinuman.class);
			}
